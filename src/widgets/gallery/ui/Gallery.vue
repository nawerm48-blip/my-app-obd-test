<script setup>
/**
 * Gallery Widget - Project gallery slider component
 */
...
// Sort gallery by level, empty values at end
...
// Chunk array: first 5, then groups of 6
const chunkArraySpecial = (array) => {
  const result = []
  if (array.length > 0) {
    result.push(array.slice(0, 5))
  }
          ...
          <div class="slider">
            <div class="slider-one">
              <ClientOnly>
                ...
                >
                  <SwiperSlide v-for="(slide, index) in chunkedImages" :key="index">
                    <div
