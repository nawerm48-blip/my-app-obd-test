<script setup>
/**
 * Category Nav Widget - Category navigation with breadcrumbs
 */
...
if (route.params.id && category && category.length > 0) {
  ...
  if (foundCategory) {
    ...
    seoTImg.value = foundCategory.seo_image || '/profiterm.webp'
  }
...
// Update breadcrumbs when h1Category changes
watchEffect(() => {
...
<template>
  <div>
    <SharedBreadcrumb :links="breadcrumbLinks" />
